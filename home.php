                    ...
                    <article class="as-grid__card">
                        ...
                        <div class="as-grid__card-wrapper">
                            ...
                            <div class="as-grid__button-wrapper">
                                <a href="product-detail.php?idproduk=9" class="as-grid__button">Lihat Detail</a>
                            </div>
                        </div>
                    </article>
                    <article class="as-grid__card">
                        <img src="src/img/usaha/16sAPYzCHUV7o.jpeg" class="as-grid__image" loading="lazy" alt="contoh">
                        <div class="as-grid__card-wrapper">
                            <h3 class="as-grid__title">Nyoklat Teen</h3>
                            <p class="as-grid__description">F&B.</p>
                            <div class="as-grid__button-wrapper">
                                <a href="product-detail.php?idproduk=1" class="as-grid__button">Lihat Detail</a>
                            </div>
                        </div>
                    </article>
                    <article class="as-grid__card">
                        ...
                        <div class="as-grid__card-wrapper">
                            ...
                            <p class="as-grid__description">F&B</p>
                            <div class="as-grid__button-wrapper">
                                <a href="product-detail.php?idproduk=13" class="as-grid__button">Lihat Detail</a>
                            </div>
                        </div>
                    </article>
                </div>
